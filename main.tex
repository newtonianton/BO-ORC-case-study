...
pinch constraint set to $\Delta T_{min,evap} = 20\,^{\circ}\text{C}$, $\Delta T_{min,cond} = 10\,^{\circ}\text{C}$, matching Table 2 of \citet{chys2012potential} for the low-temperature heat source (an earlier draft used $\Delta T_{min} = 0$; superseded)
